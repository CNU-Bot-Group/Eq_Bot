...
class ConvNetwork(nn.Module):
    ...
    The network consists of a sequence of convolutional layers, each followed by batch normalization and a GELU activation function.
    The number of output channels of the convolutional layers increases after every third layer. The network ends with a fully connected layer.
    """
...
class WideResNet50Network(nn.Module):
    ...
    def __init__(
        ...
        """
        super().__init__()
        self.wideresnet = torchvision.models.wide_resnet50_2(pretrained=True)

        # change the input layer to accept 6 channels
        in_channels = in_shape[0]
